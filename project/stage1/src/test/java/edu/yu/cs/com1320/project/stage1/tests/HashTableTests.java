package edu.yu.cs.com1320.project.stage1.tests;
...
public class HashTableTests {
    ...
    public void putAndGet() {
        HashTableImpl<Object, Object> ht = new HashTableImpl<>();
        String meir = "meir";
    ...
    public void noduplicatekeys() throws IOException, URISyntaxException {
        ...
        if(scanner.hasNextLine()) {String text1 = scanner.nextLine();}
    ...
    public void pdfs() throws IOException, URISyntaxException {
        ...
        //String pig = store.inputAsTxtForTXT(targetStream);
        //System.out.println(pig + " LOOK HERE");
        ...
        /*InputStream pdfstream = new FileInputStream("C:\\Users\\meirj\\intellijtestpdf.txt");
        Scanner scanner2 = new Scanner(pdfstream);
        String text2 = scanner2.nextLine();
        URI uri2 = new URI(text2);
        store.putDocument(pdfstream, uri2, DocumentStore.DocumentFormat.TXT);

        InputStream pdfstream1 = new FileInputStream("C:\\Users\\meirj\\intellijtestpdf.pdf");
        Scanner scanner21 = new Scanner(pdfstream1);
        String text21 = scanner21.nextLine();
        URI uri21 = new URI(text21);
        store.putDocument(pdfstream1, uri21, DocumentStore.DocumentFormat.TXT);*/
