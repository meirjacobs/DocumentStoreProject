...
public class HashTableImpl<Key, Value> implements HashTable<Key, Value> {
    ...
    private Object removeElement(Key k, Value v) {
        int i = k.hashCode();
        int i1 = hashFunction((i));
        LinkedList list = array[i1];
        ...
        Object match = list.removeElement(element);
        array[i1] = list;
        return match;
    }
...
class LinkedList {
    ...
    protected Object removeElement(LinkedListElement element) {
    ...
    protected Object editElement(LinkedListElement element) {
        resetHead();
        LinkedListElement current = this.head;
        Object hcOfEdited = null;
        while(current != null) {
            if (current.key.equals(element.key)) {
                hcOfEdited = (Object) current.value;
