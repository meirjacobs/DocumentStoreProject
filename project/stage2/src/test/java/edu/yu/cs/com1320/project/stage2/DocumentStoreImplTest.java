...
public class DocumentStoreImplTest {
    ...
    @Test
    public void undoTests() throws URISyntaxException {
        ...
        URI fakeURI = new URI("fakeURI");
        store.deleteDocument(fakeURI);
        store.undo();

        assertEquals(store.getDocumentAsTxt(uri1), pdfTxt1);
        ...
        System.out.println("HEY LOOK AT ME IM HERE");
